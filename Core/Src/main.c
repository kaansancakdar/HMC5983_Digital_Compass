...
int main(void)
{
	...
	//Set HMC5983 Regiter A, Rgister B, Mode Register
	...
	while (1)
	{
		...
		float mag_data[] = { uT_X, uT_Y, uT_Z }; //Calibated magnetometer value
		/* USER CODE BEGIN 3 */
